        ...
        <form action="${url.loginAction}" method="post">
            ...
            <#if !realm.loginWithEmailAllowed>
                <#if usernameEditDisabled??>
                    <input type="text" value="${(login.username!'')}" name="username" placeholder="${msg("username")}" class="holi-input-field" readonly />
                <#else>
                    <input type="text" value="${(login.username!'')}" name="username" placeholder="${msg("username")}" class="holi-input-field" autofocus autocomplete="off" />
                </#if>
            <#elseif !realm.registrationEmailAsUsername>
                <#if usernameEditDisabled??>
                    <input type="text" value="${(login.username!'')}" name="username" placeholder="${msg("usernameOrEmail")}" class="holi-input-field" readonly />
                <#else>
                    <input type="text"
            ...
            <#else>
                <#if usernameEditDisabled??>
                    <input type="email" value="${(login.username!'')}" name="username" placeholder="${msg("email")}" class="holi-input-field" readonly />
                <#else>
                    <input type="email" value="${(login.username!'')}" name="username" placeholder="${msg("email")}" class="holi-input-field" autofocus autocomplete="off" />
                </#if>
            </#if>

            <input id="password" class="holi-input-field" name="password" type="password" autocomplete="off" placeholder="${msg("password")}" />
